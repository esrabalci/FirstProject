...
//If NO Phone number change for any of that accounts that entered the trigger
//then the set will be empty, no point of running the rest of the code
 // how  do we get out of the trigger early--> return keyword
// return --> get out the place early so next step wont be executed

   if(accIds.isEmpty() ){

    System.debug('NO ACCOUNT PHONE NUMBER CHANGED !!!'); 

      return;// this will end this trigger execution here
      // it wont proceed to next 
...
System.debug('NO CONTACT FOUND UNDER THESE ACCOUNT!!!'); 
